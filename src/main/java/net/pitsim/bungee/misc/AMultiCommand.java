...
import net.pitsim.bungee.CommandBlocker;
import net.pitsim.bungee.guilds.commands.guildcommands.DepositCommand;
import net.pitsim.bungee.guilds.commands.guildcommands.WithdrawCommand;
	...
	public void execute(CommandSender sender, List<String> args) {
		...
		if(args.isEmpty()) {
			...
			if(subCommand instanceof WithdrawCommand || subCommand instanceof DepositCommand) {
				...
				CommandBlocker.blockPlayer(((ProxiedPlayer) sender).getUniqueId());
			}
